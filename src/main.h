...
static const unsigned int MAX_BLOCK_SIZE = 4000000;                      // 1000KB block hard limit
...
static const int64 DUST_SOFT_LIMIT = 100000; // 0.001 NCX
/** Dust Hard Limit, ignored as wallet inputs (mininput default) */
static const int64 DUST_HARD_LIMIT = 1000;   // 0.00001 NCX mininput
/** No amount larger than this (in satoshi) is valid */
static const int64 MAX_MONEY = 6025600000 * COIN; // int64 = 9223372036854775807(MAX)
...
public:
    ...
    */
    ...
    static bool AllowFree(double dPriority)
    {
        ...
        // need a fee.
        return dPriority > COIN * 720 / 250; //1day = 720 blocks
    }
